...
class BridgeTransactionAdmin(admin.ModelAdmin):
    list_display = (
        'id_short', 'status', 'from_address_short',
        'to_address_short', 'quote_link', 'initiated_at', 
        'completion_time', 'is_completed'
    )
    ...
    def quote_link(self, obj):
        url = f"/admin/bridge/bridgequote/{obj.quote.id}/change/"
    ...
    def completion_time(self, obj):
        if obj.initiated_at and obj.completed_at:
            return obj.completed_at - obj.initiated_at
        return None
